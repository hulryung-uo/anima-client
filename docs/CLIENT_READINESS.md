...
| Reliability and performance | No stale callbacks, clear disconnect/crash behavior, bounded resources, responsive long sessions | Connection races, login deadlines and preference boot failures repaired; 2026-09-13 gate passed (655 main Rust tests, 14 desktop tests, 267 web tests). Long-session, asset-cache and process-crash audit remains. |
