...
use anima_core::net::outgoing::{
    build_ascii_prompt_response, build_attack, build_bandage_target, build_book_header_change,
    build_book_page_request, build_book_page_write, build_buy, build_cast_spell,
    ...
    build_equip, build_guild_menu_request, build_gump_response, build_help_request,
    ...
    build_opl_request, build_party_accept, build_party_can_loot, build_party_decline,
    build_party_invite, build_party_leave, build_party_message, build_party_private_message,
    build_party_remove, build_pick_up, build_ping, build_popup_request, build_popup_select,
    build_profile_request, build_profile_update, build_prompt_response, build_quest_arrow_click,
    build_quest_menu_request, build_rename_request, build_say, build_sell, build_single_click,
    build_skill_lock, build_stat_lock, build_status_request, build_stun_request,
